...
export const valueProps = [
  {
    title: 'שירות מהיר',
    description: 'זמני תגובה מהירים ותיאום הזמנות בצורה נוחה וברורה מול גורם מקצועי אחד.',
  },
  {
    title: 'אספקה אמינה',
    description: 'מערך הפצה מסודר עם מחויבות לעמידה בלוחות זמנים ושמירה על איכות המוצרים.',
  },
  {
    title: 'מגוון מוצרים',
    description: 'קטלוג רחב של גבינות, מוצרי חלב, קפואים ומוצרים משלימים במקום אחד.',
  },
];
