  ...
  return (
    <div>
      <section className="container-page py-10 sm:py-14 lg:py-16">
        <div className="rounded-card bg-hero-gradient p-6 text-text-inverse shadow-card sm:p-10 lg:p-14">
          <p className="text-sm font-semibold text-bg-soft">שיווק והפצה לעסקים (B2B) וגם ללקוחות פרטיים</p>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">{business.name}</h1>
          <p className="mt-5 max-w-3xl text-base leading-8 text-bg-soft sm:text-lg">{business.subtitle}</p>
        </div>
      </section>
      ...
      <section className="container-page py-8 sm:py-10 lg:py-12">
        <div className="flex items-end justify-between gap-4">
          ...
          <Link href="/categories" className="text-sm font-semibold text-brand-primary hover:text-brand-secondary">
            לכל הקטגוריות ←
          </Link>
        </div>
